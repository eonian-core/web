...
function IconDAI({ noBackground, ...restProps }: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 444.44 444.44" {...restProps}>
      <g>
        {!noBackground && (
          <path
            fill="#F5AC37"
        ...
        <path
          fill={noBackground ? 'currentColor' : '#FEFEFD'}
          fillRule="nonzero"
