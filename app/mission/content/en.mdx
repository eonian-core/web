...
<Solution>
    ...
    That's why we decided to build the first [decentralized savings account](https://docs.eonian.finance/basics/the-eonian-protocol), which prioritizes security.
